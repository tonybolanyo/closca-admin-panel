...
// ng-gnommo-base - commented out until Angular upgrade
// import { GnommoBaseModule } from '@tyris/angular-foundation-libs';
...
@NgModule({
  imports: [
    ...
    // GnommoBaseModule.forRoot({}), // commented out until Angular upgrade
